/**
 * =================================================================================
 * BLEM'S PIZZARIA - MOTOR DE BANCO DE DADOS DE CLIENTE (db.js)
 * =================================================================================
 * Este arquivo substitui o banco de dados externo e o servidor Express por uma engine
 * cliente autônoma e resiliente que utiliza LocalStorage e estruturas em memória.
 * 
 * Funcionalidades:
 * - Leitura e filtro de itens do cardápio inicial (pizzas, acompanhamentos, bebidas, sobremesas)
 * - Criação e persistência de pedidos com código de rastreamento único (ex: BLEM-84920)
 * - Busca de pedidos por código para a timeline do Order Tracker
 * - Atualização de status de pedidos pelo Painel Administrador
 * - Criação e persistência de reservas de mesa
 * - Armazenamento de avaliações dos clientes
 * 
 * Todos os comentários estão em Português (BR).
 * =================================================================================
 */

// Chaves utilizadas para armazenar os dados no LocalStorage
const STORAGE_KEYS = {
...
// Cardápio Inicial de Assinatura (Dados do Cardápio)
const INITIAL_MENU = [
    // Pizzas de Assinatura
    ...
    // Entradas e Acompanhamentos (Sides)
...
// Avaliações Iniciais dos Clientes
...
/**
 * Objeto Global de Operações de Banco de Dados (BlemsDB)
 */
const BlemsDB = {
    /**
     * Retorna todos os itens do cardápio
     * @returns {Array} Lista de pratos
     */
    getMenu() {
        return INITIAL_MENU;
    },
    ...
    /**
     * Retorna as avaliações salvas no LocalStorage ou o padrão
     ...
     * @returns {Object} Pedido criado com código de rastreamento
     */
    createOrder(orderData) {
        const orders = this.getOrders();
        
        // Gera um código de rastreamento único no padrão BLEM-XXXXXX
        ...
        const newOrder = {
            ...
            status: 'Received', // Status inicial: 'Received', 'Preparing', 'In Oven', 'Out for Delivery', 'Completed'
    ...
    /**
     * Busca um pedido pelo código de rastreamento (ex: BLEM-84920)
     * @param {string} code - Código de rastreamento
     * @returns {Object|null} Objeto do pedido encontrado ou null
     */
    getOrderByCode(code) {
        const orders = this.getOrders();
    ...
    /**
     * Atualiza o status de um pedido existente no banco
    ...
    /**
     * Retorna todas as reservas de mesa salvas
    ...
    /**
     * Cria e salva uma nova reserva de mesa no LocalStorage
     * @param {Object} resData - Dados da reserva
     * @returns {Object} Confirmação da reserva
     */
